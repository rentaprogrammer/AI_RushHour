...
public class AStar {
	...
	public State[] path;
	private PriorityQueue<ComparableNode> openList = 
			new PriorityQueue<ComparableNode>(new QueueComperator());
	...
	public void getSolutionPath(ComparableNode currentNode) {
